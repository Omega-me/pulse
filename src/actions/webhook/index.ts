...
export const onGenerateSmartAiMessage = async (messages: Dms[], prompt: string) => {
  try {
    ...
    const { text } = await generateText({
      ...
      messages: [
        {
          content: 'Do not give answers longer than 2 sentences and you will speak in albanian language all the time',
          role: 'system',
        },
        ...formattedMessages,
        promptMessage,
